<?php
$web = [
	'title' => __('Kavárna', 'cms_ve'),
	'desc' => '',
	'demo' => 'http://demo-cafe2.mioweb.cz',
	'tags' => ['restaurant'],
	'thumb' => get_template_directory_uri() . '/library/visualeditor/web_templates/cafe2/thumb.jpg',
	'thumb_en' => get_template_directory_uri() . '/library/visualeditor/web_templates/cafe2/thumb.jpg',
	'home' => 'page',
	'pages' => [
		'blog' => [
