				...
				'content' => [
					'0' => [
						...
						'style' => [
							...
							'decoration-color' => '#158ebf',
							'align' => 'center',
							'content' => '<h2 style="text-align: center;">KRÁSNÉ PROSTŘEDÍ. SKVĚLÁ KUCHYNĚ.</h2>',
							'mw30' => '1',
						],
						'config' => [
							'margin_top' => '0',
				...
				'content' => [
					'0' => [
						...
						'style' => [
							...
							'decoration-color' => '#158ebf',
							'align' => 'center',
							'content' => '<h2 style="text-align: center;">' . __('NAŠE KUCHYNĚ', 'cms_ve') . '</h2>',
							'mw30' => '1',
						],
						'config' => [
							'margin_top' => '0',
...
$page = ['page' => ['title' => __('O restauraci', 'cms_ve'), 'slug' => __('o-restauraci', 'cms_ve'), 'theme' => 'page/1/'], 'setting' => [], 'layer' => base64_encode(serialize($temp_layer))];
