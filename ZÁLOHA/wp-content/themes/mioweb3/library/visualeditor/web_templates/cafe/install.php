<?php
$web = [
	'title' => __('Moderní kavárna', 'cms_ve'),
	'desc' => '',
	'demo' => 'http://demo-cafe.mioweb.cz',
	'tags' => ['restaurant'],
	'thumb' => get_template_directory_uri() . '/library/visualeditor/web_templates/cafe/thumb.jpg',
	'thumb_en' => get_template_directory_uri() . '/library/visualeditor/web_templates/cafe/thumb.jpg',
	'home' => 'page',
	'pages' => [
		'blog' => [
