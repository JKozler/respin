				...
				'content' => [
					'0' => [
						...
						'style' => [
							...
							'align' => 'center',
							'content' => '<h2 style="text-align: center;">Pizzy</h2>',
							'mw30' => '1',
						],
						'config' => [
							'margin_top' => '0',
				...
				'content' => [
					'0' => [
						...
						'style' => [
							...
							'decoration-color' => '#56b616',
							'align' => 'center',
							'content' => '<h2 style="text-align: center;">Saláty</h2>',
							'mw30' => '1',
						],
						'config' => [
							'margin_top' => '0',
...
$page = ['page' => ['title' => __('Menu', 'cms_ve'), 'slug' => __('menu', 'cms_ve'), 'theme' => 'page/1/'], 'setting' => [], 'layer' => base64_encode(serialize($temp_layer))];
