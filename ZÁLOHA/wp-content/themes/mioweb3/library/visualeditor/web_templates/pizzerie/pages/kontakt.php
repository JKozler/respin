				...
				'content' => [
					'0' => [
						'style' => [
							'icon' => [
								'icon' => 'clipboard',
								'code' => '<svg role="img"><use xlink:href="http://localhost/mioweb6/wp-content/themes/mioweb/library/visualeditor/images/icons/feather/symbol-defs.svg#icon-clipboard"></use></svg>',
								'icon_set' => 'feather',
								'tab' => 'icon',
							],
					...
					'2' => [
						'style' => [
							'icon' => [
								'icon' => 'clock',
								'code' => '<svg role="img"><use xlink:href="http://localhost/mioweb6/wp-content/themes/mioweb/library/visualeditor/images/icons/feather/symbol-defs.svg#icon-clock"></use></svg>',
								'icon_set' => 'feather',
								'tab' => 'icon',
							],
							'title' => 'Otvírací doba',
					...
					'4' => [
						'style' => [
							'icon' => [
								'icon' => 'map-pin',
								'code' => '<svg role="img"><use xlink:href="http://localhost/mioweb6/wp-content/themes/mioweb/library/visualeditor/images/icons/feather/symbol-defs.svg#icon-map-pin"></use></svg>',
								'icon_set' => 'feather',
								'tab' => 'icon',
							],
