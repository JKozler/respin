...
$temp_layer = [
	'0' => [
		...
		'style' => [
			...
			'background_image' => [
				'position' => '50% 50%',
				'image' => MW_IMAGE_LIBRARY . 'webs/restaurant/pizzabg.jpg',
				'imageid' => '',
				'pattern' => '',
				'tablet' => [
					'position' => '50% 50%',
							...
							'0' => [
								'0' => [
									...
									'style' => [
										...
										'align' => 'center',
										'content' => '<h2 style="text-align: center;">' . __('Rezervace', 'cms_ve') . '</h2>',
										'mw30' => '1',
									],
									'config' => [
										'margin_top' => '0',
								...
								'2' => [
									'style' => [
										'icon' => [
											'icon' => 'phone-call',
											'code' => '<svg role="img"><use xlink:href="http://localhost/mioweb6/wp-content/themes/mioweb/library/visualeditor/images/icons/feather/symbol-defs.svg#icon-phone-call"></use></svg>',
											'icon_set' => 'feather',
											'tab' => 'icon',
										],
										'title' => '605 123 456',
				...
				'content' => [
					'0' => [
						'style' => [
							...
							'decoration-color' => '#158ebf',
							'align' => 'center',
							'content' => '<p style="text-align: left;">Otvírací doba</p>',
							'mw30' => '1',
						],
						'type' => 'title',
						'config' => [
					...
					'1' => [
						...
						'style' => [
							...
							'content' => '<p style="text-align: left;">Po - Pá: 10:00 - 22:00<br />So - Ne: 10:00 - 23:00</p>',
							'li' => '',
							'mw30' => '1',
						],
						'config' => [
				...
				'content' => [
					'0' => [
						'style' => [
							...
							'decoration-color' => '#158ebf',
							'align' => 'center',
							'content' => '<p style="text-align: center;">Pizzerie</p>',
							'mw30' => '1',
						],
						'type' => 'title',
						'config' => [
					...
					'1' => [
						'style' => [
							...
							'content' => '<p style="text-align: center;">© 2019</p>',
							'li' => '',
							'mw30' => '1',
						],
						'type' => 'text',
