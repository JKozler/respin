			...
			'content' => [
				...
				'1' => [
					'style' => [
						...
						'align' => 'center',
						'content' => '<p>' . __('Název bloku', 'cms_ve') . '</p>',
						'mw30' => '1',
					],
					'type' => 'title',
					'config' => [
				...
				'2' => [
					'style' => [
						...
						'content' => '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In volutpat volutpat blandit. In hac habitasse platea tortor dictumst. Lorem ipsum dolor sit amet, consectetur adipiscing elit. In volutpat volutpat blandit. In hac habitasse platea tortor dictumst consectetur adipiscing. </p>',
						'li' => '',
						'mw30' => '1',
					],
					'type' => 'text',
