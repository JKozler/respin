			...
			'content' => [
				...
				'2' => [
					'style' => [
						...
						'content' => '<p style="text-align: left;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In volutpat volutpat blandit. In hac habitasse platea dictumst. Quisque ac dolor a tellus pharetra porta. In tortor felis, iaculis vel tincidunt in.</p>',
						'li' => '',
						'mw30' => '1',
					],
					'type' => 'text',
