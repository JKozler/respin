			...
			'content' => [
				...
				'2' => [
					'style' => [
						...
						'content' => '<p style="text-align: center;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In volutpat volutpat blandit. In hac habitasse platea dictumst. Quisque ac dolor a tellus pharetra porta.</p>',
						'li' => '',
						'mw30' => '1',
					],
					'type' => 'text',
