			...
			'content' => [
				...
				'2' => [
					...
					'style' => [
						...
						'content' => '<p style="text-align: center;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam ac dolor at leo feugiat convallis. Donec congue porttitor scelerisque. Donec leo ligula, porttitor non enim id, mattis tristique tellus. Etiam ac elementum leo.</p>',
						'li' => '',
						'mw30' => '1',
					],
					'config' => [
