...
use Mioweb\HttpClient\Exceptions\NotSupportedException;
...
class CurlHttpClient implements IHttpClient
{
	...
	public function sendHttpRequest(HttpRequest $httpRequest): HttpResponse
	{
		...
		$header = \substr((string) $result, 0, $headerSize);
	 ...
	 * @return void
	 */
	private static function setDefaultContentType(array &$headers, string $contentType): void
	{
