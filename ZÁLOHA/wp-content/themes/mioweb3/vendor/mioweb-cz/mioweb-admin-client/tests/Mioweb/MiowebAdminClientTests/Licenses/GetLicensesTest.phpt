...
use Mioweb\MiowebAdminClientTests\Licenses\MockHttpClients\GetLicensesMockHttpClient;
use Tester\Assert;
use Tester\Environment;

require __DIR__ . '/../../../bootstrap.php';
require __DIR__ . '/MockHttpClients/GetLicensesMockHttpClient.php';

class GetLicensesTest extends BaseTestCase
{

	private bool $generateMockHttpClient = false;

	/** @var CapturingHttpClient|GetLicensesMockHttpClient */
	private $httpClient;
	...
	{
		$licenses = $this->miowebAdminClient->getLicenses([
			'email' => 'mw-client-test-124@mesour.com',
			'limit' => 1,
		]);

		Assert::type('array', $licenses);
		Assert::count(1, $licenses);
		Assert::type('array', $licenses[0]);
	...
	protected function tearDown(): void
	{
		if ($this->generateMockHttpClient) {
			$this->httpClient->writeToPhpFile(
				__DIR__ . '/MockHttpClients/GetLicensesMockHttpClient.php',
				GetLicensesMockHttpClient::class,
			);
		}
	}
