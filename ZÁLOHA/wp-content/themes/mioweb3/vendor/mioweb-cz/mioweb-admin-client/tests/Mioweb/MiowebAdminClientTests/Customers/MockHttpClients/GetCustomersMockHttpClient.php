...
class GetCustomersMockHttpClient extends MockHttpClient
{
	...
	public function __construct()
	{
		$this->add(
			new HttpRequest(
				'http://mioweb-admin.dev/api/v3/customers?email=mw-client-test-124%40mesour.com&limit=1',
				'GET',
				[
					'auth' => ['admin', 'admin'],
			...
			new HttpResponse(
				200,
				[
					'Date' => ['Sun, 05 Nov 2017 14:21:11 GMT'],
					...
					'Pragma' => ['no-cache'],
					'Set-Cookie' => [
						'PHPSESSID=a4s2lijq8l4p0mi0ds3g5fmf71; expires=Sun, 19-Nov-2017 14:21:11 GMT; Max-Age=1209600; path=/; HttpOnly',
						'PHPSESSID=kfler1mikd965bfdsl9fsl5gm7; expires=Sun, 19-Nov-2017 14:21:11 GMT; Max-Age=1209600; path=/; HttpOnly',
						'PHPSESSID=kfler1mikd965bfdsl9fsl5gm7; expires=Sun, 19-Nov-2017 14:21:11 GMT; Max-Age=1209600; path=/; HttpOnly',
					],
