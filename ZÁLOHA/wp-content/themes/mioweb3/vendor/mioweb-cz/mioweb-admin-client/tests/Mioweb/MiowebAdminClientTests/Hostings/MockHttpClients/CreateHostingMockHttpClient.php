...
class CreateHostingMockHttpClient extends MockHttpClient
{
	...
	public function __construct()
	{
		$this->add(
			new HttpRequest(
				'http://mioweb-admin.dev/api/v3/hostings',
				'POST',
				[
					'auth' => ['admin', 'admin'],
			...
			new HttpResponse(
				201,
				[
					'Date' => ['Sun, 05 Nov 2017 15:01:00 GMT'],
					...
					'Pragma' => ['no-cache'],
					'Set-Cookie' => [
						'PHPSESSID=dhfg3524na2r298nch668c0aj7; expires=Sun, 19-Nov-2017 15:01:00 GMT; Max-Age=1209600; path=/; HttpOnly',
						'PHPSESSID=afhp9h3srh9cj8qt7e3sipgf66; expires=Sun, 19-Nov-2017 15:01:00 GMT; Max-Age=1209600; path=/; HttpOnly',
						'PHPSESSID=afhp9h3srh9cj8qt7e3sipgf66; expires=Sun, 19-Nov-2017 15:01:00 GMT; Max-Age=1209600; path=/; HttpOnly',
					],
