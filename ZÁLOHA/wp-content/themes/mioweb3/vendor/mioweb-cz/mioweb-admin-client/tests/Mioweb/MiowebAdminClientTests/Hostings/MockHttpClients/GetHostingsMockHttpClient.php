...
class GetHostingsMockHttpClient extends MockHttpClient
{
	...
	public function __construct()
	{
		$this->add(
			new HttpRequest(
				'http://mioweb-admin.dev/api/v3/hostings?email=mw-client-test-124%40mesour.com&limit=1',
				'GET',
				[
					'auth' => ['admin', 'admin'],
			...
			new HttpResponse(
				200,
				[
					'Date' => ['Sun, 05 Nov 2017 15:06:08 GMT'],
					...
					'Pragma' => ['no-cache'],
					'Set-Cookie' => [
						'PHPSESSID=lpkj6u72p247a08pbib5k9ipa5; expires=Sun, 19-Nov-2017 15:06:08 GMT; Max-Age=1209600; path=/; HttpOnly',
						'PHPSESSID=s7qm2ensefckbibk310s10ff12; expires=Sun, 19-Nov-2017 15:06:08 GMT; Max-Age=1209600; path=/; HttpOnly',
						'PHPSESSID=s7qm2ensefckbibk310s10ff12; expires=Sun, 19-Nov-2017 15:06:08 GMT; Max-Age=1209600; path=/; HttpOnly',
					],
