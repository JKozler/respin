...
if (isset($blog_setting['comments']['wordpress'])) {
	$article_meta .= '<a class="comments" href="' . get_comments_link() . '">' . mwBlog()->get_blog_icon('comments') . $comments . ' ' . ($comments == 1 ? __('Komentář', 'cms_blog') : ($comments > 1 && $comments < 5 ? __('Komentáře', 'cms_blog') : __('Komentářů', 'cms_blog'))) . '</a>';
}
...
<div id="blog-container">
	...
	<div id="blog-content">
		...
		<div class="blog-box blog-singlebox article-detail">
			...
			<div id="blog_comments_container"><?php mwBlog()->print_blog_comments(); ?></div>
		</div>
	</div>
