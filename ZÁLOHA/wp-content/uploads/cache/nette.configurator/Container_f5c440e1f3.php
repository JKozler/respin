...
class Container_f5c440e1f3 extends Nette\DI\Container
{
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'wwwDir' => '/data/web/virtuals/230071/virtual/www/domains/respinteam.cz/wp-admin/user',
	...
	public function createServiceContainer(): Container_f5c440e1f3
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_f5c440e1f3 $container)
			{
