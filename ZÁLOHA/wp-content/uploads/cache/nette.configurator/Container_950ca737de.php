...
class Container_950ca737de extends Nette\DI\Container
{
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'wwwDir' => '/data/web/virtuals/230071/virtual/www/domains/respinteam.cz',
	...
	public function createServiceContainer(): Container_950ca737de
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_950ca737de $container)
			{
